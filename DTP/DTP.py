...
def registration_no():
    file=openpyxl.load_workbook('DTP.xlsx')
    sheet=file.active
    row=sheet.max_row
...
#top frames
Label(root,text="New Student Registration for DTP", font='Palatino 22',anchor='center',fg="#000",bg="#f9fcae").place(x=400,y=35)
