...
def New_REG():
    subprocess.run(["python", "DTP.py"])  # Run the Tally.py script in a new process

def Attend():
    subprocess.run(["python", "DTP_Attend.py"])  # Run the Tally_Attend.py script

def TallyDB():
    subprocess.run(["python", "DTP_DB.py"])
...
bg_image = tk.PhotoImage(file="Images/DTP.png") 
