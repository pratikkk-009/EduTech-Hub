...
root=Tk()
root.title("C++ Programming Regestration")
...
def showimage():
    ...
    # CPPheck if a file was selected
    if filename:
        try:
...
def registration_no():
    file=openpyxl.load_workbook('CPP.xlsx')
    sheet=file.active
    row=sheet.max_row
...
#top frames
Label(root,text="New Student Registration for C", font='Palatino 22',anchor='center',fg="#000",bg="#f9fcae").place(x=400,y=35)
