...
def registration_no():
    file=openpyxl.load_workbook('Tally.xlsx')
    sheet=file.active
    row=sheet.max_row
...
#top frames
Label(root,text="New Student Registration for TALLY", font='Palatino 22',anchor='center',fg="#000",bg="#f9fcae").place(x=384,y=35)
