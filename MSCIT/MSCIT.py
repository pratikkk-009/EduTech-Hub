...
root=Tk()
root.title("MS-CIT Registration")
...
def registration_no():
    file=openpyxl.load_workbook('MSCIT.xlsx')
    sheet=file.active
    row=sheet.max_row
...
#top frames
Label(root,text="New Student Registration for MS-CIT", font='Palatino 20',anchor='center',fg="#000",bg="#f9fcae").place(x=384,y=35)
